...
export async function searchWikimedia(query, limit = 14) {
  ...
  // No filetype: filter — combined with multi-word queries it collapses
  // results to near-zero. The mime-type filter further down rejects non-images
  // (PDFs, audio, etc.) which is what we actually need.
