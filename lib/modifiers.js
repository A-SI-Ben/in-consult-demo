...
export const CATEGORIES = [
  {
    ...
    queryModifier: 'diagram',
    prefersDrawings: true,
  },
  {
    label: 'Overview/Image',
    queryModifier: 'clinical',
...
// Empty by default — adding a universal word like "medical" sounds helpful but
// pushes total query length to 4+ words and degrades source relevance scoring.
// If a future test shows a single biasing word genuinely helps across the
// board, add it here.
